            ...
            "signals": [
                {
                    ...
                    "signal_unit": "kWh",
                    "data": [
                        {"ts": "2023-08-01 13:15:00", "value": 7308},
                ...
                },
                {
                    ...
                    "signal_unit": "kWh",
                    "data": [
                        {"ts": "2023-08-01 13:15:00", "value": 23928},
...
def test___store_dset_historic__base_case(dbconnection, dset_config, dset_tables):
    ...
    response = httpx.Response(
        ...
        json=response_body,
        headers={},
        request=httpx.Request("GET", url=endpoint, params=params),
    )
    stored_readings = store_dset_response(
        dbconnection, response, endpoint, params=params, schema="public"
    )
    print(stored_readings)
    assert len(stored_readings) > 0
...
def test___localize_time_range():
    ...
    assert from_ts_local.astimezone(datetime.timezone.utc) == from_ts.astimezone(
